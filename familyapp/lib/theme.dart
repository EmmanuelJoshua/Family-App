...
TextStyle leadlines = TextStyle(fontSize: 18, color: Colors.black26, fontFamily: 'PTsans', fontWeight: FontWeight.w400);
TextStyle tabheads = TextStyle(fontSize: 16, fontFamily: 'PTsans', fontWeight: FontWeight.w600);
